...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Kinnari Kamani\\Desktop\\Monsoon 2022\\PSY310 Lab in Psych\\Tutorials_Exp\\T7_lastrun.py',
...
text = visual.TextStim(win=win, name='text',
    text="Report the delay between the key press and the beep on a scale of 0 - 999; Click 'submit' after entering the value.",
    font='Open Sans',
...
button = visual.ButtonStim(win, 
    text='Submit response', font='Arvo',
    pos=(0, -0.3),
    letterHeight=0.05,
...
trials = data.TrialHandler(nReps=5.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/Kinnari Kamani/Desktop/Monsoon 2022/PSY310 Lab in Psych/Tutorials_Exp/excel/ib conditions.xlsx'),
